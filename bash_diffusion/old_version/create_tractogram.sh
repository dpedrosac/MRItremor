...
# version: 2022-16-07 # small changes in the code
...
echo
for_each rawdata/* : tckgen -act IN/5tt_coreg.mif \
...
echo
for_each rawdata/{3011S,4699S,4723S,4858S} : tcksift2 -act IN/5tt_coreg.mif \
-out_mu IN/sift_mu.txt \
-out_coeffs IN/sift_coeffs.txt \
-nthreads 20 IN/tracks_10M.tck IN/wmfod_norm.mif IN/sift_1M.txt -force
echo
echo "Done!"
echo "======================================================================"
echo
